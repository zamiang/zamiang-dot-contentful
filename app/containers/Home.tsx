      ...
      <div className={cx("home")}>
        ...
        <div className={cx("section")}>
          ...
          <div className={cx("project")}>
            ...
            <div className={cx("description")}>
              Director of Web Engineering 2011-2014, responsible for making sure Artsy’s public facing web
               presence is fast and maintainable.
            </div>
          </div>
          <div className={cx("project")}>
          ...
          <div className={cx("project")}>
            <h2>
              <a
                href="http://www.kickstarter.com/projects/zamiang/explore-and-organize-your-data-with-poyozo">Poyozo</a>
            </h2>
            <div className={cx("description")}>
              Poyozo helps you keep track of and understand your life by integrating automatic life-tracking with simple
